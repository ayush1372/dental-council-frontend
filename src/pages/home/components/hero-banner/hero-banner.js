    ...
    >
      <Container className={styles.bannerWrapper}>
        <Grid container spacing={3} direction={{ xs: 'column', sm: 'row' }}>
          <Grid item xs={12} sm={2.7} mt={13} sx={{
            display: "flex",
            alignItems: "end"
          }}>
          ...
          <Grid item xs={12} sm={5.5} mt={10}>
            ...
            >
              <ul style={{ fontSize: '17.5px', paddingLeft: '.5em' }}>
                <li>{t('National Dental Register (NDR) is dynamic database of all the dentists in India.')}</li>
                <li>{t('It would counter the challenges faced by professionals regarding interstate movement of dentists, duplicate registration across state, complex renewal process etc.')}</li>
                <li>{t('NDR would provide a Unique Identifier to all the dentists practicing in India, and also the professionals gets registered in Healthcare Professional Registry (HPR), after verification by State Dental Council')}</li>
                <li>{t('The NDR will also help citizens to identify the Dental Professionals verified by the State Dental Councils and will facilitate the improvement in dentalcare delivery across the country.')}</li>
              </ul>
            </Typography>
          </Grid>

          <Grid item xs={12} sm={0.3}></Grid>
          <Grid item xs={12} sm={3.15} mt={3} sx={{
            display: "flex",
            alignItems: "end"
          }}>
