...
export const consentDescription =
  'I, hereby declare that I am voluntarily sharing my Aadhaar Number and demographic information issued by UIDAI, with Dental Council of India (DCI) and National Health Authority (NHA) for the sole purpose of creation of User ID. I understand that my User ID can be used and shared for purposes as may be notified by DCI from time to time. Further, I am aware that my personal identifiable information (Name, Address, Age, Date of Birth, Gender and Photograph) may be made available to the entities working in the Dental Council of India (DCI) and National Digital Health Ecosystem (NDHE) Ecosystem which inter alia includes stakeholders and entities such as Dental Council of India, National Health Authority (NHA), State Dental Council, Medical Colleges, healthcare (e.g. doctors), National Board of Examination, which are registered with or linked to the Dental Council of India (DCI) and Ayushman Bharat Digital Mission (ABDM), and various processes there under. I authorize DCI and National Health Authority (NHA) to use my Aadhaar number for performing Aadhaar based authentication with UIDAI as per the provisions of the Aadhaar (Targeted Delivery of Financial and other Subsidies, Benefits and Services) Act, 2016 for the aforesaid purpose. I understand that UIDAI will share my e-KYC details, or response of “Yes” with DCI and NHA upon successful authentication. I have been duly informed about the option of using other IDs apart from Aadhaar; however, I consciously choose to use Aadhaar number for the purpose of availing benefits across the DCI and NDHE. I am aware that my personal identifiable information excluding Aadhaar number / VID number can be used and shared for purposes as mentioned above. I reserve the right to revoke the given consent at any point of time as per provisions of Aadhaar Act and Regulations.';
...
export const DashboardData = [
  ...
  { header: 'DCI Verification Status', key: 'nmc_status' },
